...
namespace Employees
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        protected void ShowData()
            {
                ...
                con.Open();
            adapt = new SqlDataAdapter("EmpDetails", con);
        ...
        /// <summary>
        /// updating the database from the data obtained from gridview
        /// </summary>
        ...
        protected void GridView1_RowUpdating(object sender, System.Web.UI.WebControls.GridViewUpdateEventArgs e)
        {
            ...
            TextBox EmergencyContact = GridView1.Rows[e.RowIndex].FindControl("txt_EmergencyContact") as TextBox;
            TextBox PAN = GridView1.Rows[e.RowIndex].FindControl("txt_PAN") as TextBox;
            TextBox Certifications= GridView1.Rows[e.RowIndex].FindControl("txt_Certifications") as TextBox;
            con = new SqlConnection(strcon);
            
            //updating the record  
            SqlCommand cmd1;
            cmd1 = new SqlCommand("adminEdit", con);
            ...
            cmd1.Parameters.AddWithValue("@EmergencyContact", EmergencyContact.Text);
            cmd1.Parameters.AddWithValue("@PAN", PAN.Text);
            cmd1.Parameters.AddWithValue("@Certifications", Certifications.Text);
            con.Open();
